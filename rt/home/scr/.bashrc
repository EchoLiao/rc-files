...
alias fich='find .   -type f -a \( -name "*\.c" -o -name "*\.h" -o -name "*\.cpp" \) | xargs egrep -n --color=ALWAYS '
alias fichi='find .  -type f -a \( -name "*\.c" -o -name "*\.h" -o -name "*\.cpp" \) | xargs egrep -n --color=ALWAYS -i'
alias fichiw='find . -type f -a \( -name "*\.c" -o -name "*\.h" -o -name "*\.cpp" \) | xargs egrep -n --color=ALWAYS -i -w '
alias fichw='find .  -type f -a \( -name "*\.c" -o -name "*\.h" -o -name "*\.cpp" \) | xargs egrep -n --color=ALWAYS -w '
alias fif='find .   -type f | xargs egrep -n --color=ALWAYS '
alias fifi='find .   -type f | xargs egrep -n --color=ALWAYS -i'
alias fifiw='find .   -type f | xargs egrep -n --color=ALWAYS -i -w'
alias fifw='find .   -type f | xargs egrep -n --color=ALWAYS -w'
